...
def test_get_distance_metric_list(request_, y_true, y_pred) -> None:
    from radar_builtins.metrics.distance import get_distance_metric_list
...
def test_get_distance_metric(func, y_true, y_pred) -> None:
    from radar_builtins.metrics.distance import get_distance_metric
...
def test_l_inf_norm(y_true, y_pred, expected) -> None:
    from radar_builtins.metrics.distance import l_inf_norm
...
def test_l_1_norm(y_true, y_pred, expected) -> None:
    from radar_builtins.metrics.distance import l_1_norm
...
def test_l_2_norm(y_true, y_pred, expected) -> None:
    from radar_builtins.metrics.distance import l_2_norm
...
def test_paired_cosine_similarities(y_true, y_pred, expected) -> None:
    from radar_builtins.metrics.distance import (
        _flatten_batch,
        _normalize_batch,
        paired_cosine_similarities,
    )
...
def test__flatten_batch(X) -> None:
    from radar_builtins.metrics.distance import _flatten_batch
...
def test__normalize_batch(X, order) -> None:
    from radar_builtins.metrics.distance import _flatten_batch, _normalize_batch
