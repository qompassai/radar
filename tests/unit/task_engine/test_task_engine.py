...
import radar.pyplugs
import radar.pyplugs._plugins
import radar.task_engine.task_engine
from radar.sdk.exceptions.task_engine import (
...
def pyplugs_register(*funcs: Callable[..., Any]) -> Iterator[None]:
    ...
    try:
        ...
        # non-public API.
        plugin_registry = radar.pyplugs._plugins._PLUGINS
...
def test_single_call_positional() -> None:
    ...
    radar.task_engine.task_engine.run_experiment(desc, {})
...
def test_globals_dict_nodefault() -> None:
    ...
    radar.task_engine.task_engine.run_experiment(desc, {"global_in": 2})
