...
_CUSTOM_PLUGINS_IMPORT_PATH: str = "radar_custom"
...
if __name__ == "__main__":
    log_level: str = os.getenv("RADAR_JOB_LOG_LEVEL", default="INFO")
    as_json: bool = True if os.getenv("RADAR_JOB_LOG_AS_JSON") else False
