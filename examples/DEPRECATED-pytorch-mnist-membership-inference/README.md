...
The demo provided in the Jupyter notebook `demo.ipynb` uses Radar to run experiments that investigate the membership inference attack when launched on a neural network model trained on the MNIST dataset.
