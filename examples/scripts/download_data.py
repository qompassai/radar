...
"""Fetch and organize the datasets used in Radar's examples and demos.

The Radar examples assume that the worker containers have access to datasets nested
under the path /radar/data. This path is a host directory or named volume that is
...
def mnist(ctx: Context) -> None:
    ...
    console.print_title("Radar Examples - Data Downloader")
