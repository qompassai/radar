...
from radar.sdk.generics import estimator_predict, fit_estimator
...
def fit(
    ...
    This task plugin wraps :py:func:`~radar.sdk.generics.fit_estimator`, which is a
    ...
    advertised plugin entry point `radar.generics.fit_estimator` are used to build the
    ...
    See Also:
        - :py:func:`radar.sdk.generics.fit_estimator`
    """
...
def predict(
    ...
    This task plugin wraps :py:func:`~radar.sdk.generics.estimator_predict`, which is
    ...
    the advertised plugin entry point `radar.generics.estimator_predict` are used to
    ...
    See Also:
        - :py:func:`radar.sdk.generics.estimator_predict`
    """
