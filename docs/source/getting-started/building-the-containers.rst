...
You will need to build several container images using the Dockerfiles in the Radar GitHub repository before you can run Radar for the first time.
...
.. tab-set::
   ...
   .. tab-item:: Clone with HTTPS
      ...
      .. code:: sh
         ...
         git clone https://github.com/usnistgov/radar.git

   .. tab-item:: Clone with SSH

      .. code:: sh

         git clone git@github.com:usnistgov/radar.git
...
See the `docker/ca-certificates/README.md <https://github.com/usnistgov/radar/blob/main/docker/ca-certificates/README.md>`__ file for additional information.
...
If you are running Radar on a host machine that has one or more CUDA-compatible GPUs, then it is recommended that you also build the GPU-enabled images:
...
.. code:: text
   ...
   radar/nginx                        dev       17235f76d81c   3 weeks ago     243MB
   radar/restapi                      dev       f7e59af397ae   3 weeks ago     1.16GB
   radar/mlflow-tracking              dev       56c574822dad   3 weeks ago     1.04GB
   radar/pytorch-cpu                  dev       5309d66defd5   3 weeks ago     3.74GB
   radar/tensorflow2-cpu              dev       13c4784dd4f0   3 weeks ago     3.73GB
