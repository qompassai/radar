...
This installation guide is divided into three parts, with the first part covering system requirements, the second part covering how to install the ``radar`` Python package, and the third part covering how to setup a personal computer for test-driving the Radar architecture locally.
...
The minimum requirements for installing the ``radar`` Python package on your host device are as follows:
...
.. note::
   ...
   Radar was developed for use with native GNU/Linux environments.
