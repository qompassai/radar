...
PASSWORD_FILES: list[tuple[Path, Path]] = [
    ...
    (
        Path("scripts", "templates", "radar.service.j2"),
        Path("systemd", "radar.service"),
    ),
]
...
def generate_random_passwords(words_file: str | Path) -> dict[str, Any]:
    ...
    return dict(
        ...
        postgres_user_radar_password=_generate_random_password(
            words,
            min_words=3,
            min_length=20,
            capitalize=False,
        ...
        radar_worker_password=_generate_random_password(
            words,
            min_words=3,
            min_length=20,
        ),
