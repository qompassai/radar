...
from radar.task_engine import types
...
def build_type(
    ...
    if super_type and (structure or member_types):
        raise RadarTypeError("Structure/union types can't have a super-type")

    if structure and member_types:
        raise RadarTypeError("A type may not be both structured and union")
