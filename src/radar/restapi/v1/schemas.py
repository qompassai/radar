...
def generate_base_resource_schema(name: str, snapshot: bool) -> type[Schema]:
    ...
    from radar.restapi.v1.groups.schema import GroupRefSchema
    from radar.restapi.v1.tags.schema import TagRefSchema
    from radar.restapi.v1.users.schema import UserRefSchema
