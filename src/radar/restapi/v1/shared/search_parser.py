...
"""
A module for Radar's REST API query language.
...
from radar.restapi.errors import SearchParseError


def _define_query_grammar() -> pp.ParserElement:
    """
    Defines the grammar for the Radar query language. The value of the REST
...
RADAR_QUERY_GRAMMAR = _define_query_grammar()
...
def parse_search_text(search_text: str) -> list[dict]:
    ...
    parsed_search = RADAR_QUERY_GRAMMAR.parse_string(
