...
from radar.restapi.v1.artifacts.schema import ArtifactRefSchema
from radar.restapi.v1.schemas import (
    BasePageSchema,
...
class JobSchema(JobBaseSchema):  # type: ignore
    ...
    from radar.restapi.v1.entrypoints.schema import EntrypointSnapshotRefSchema
    from radar.restapi.v1.experiments.schema import ExperimentSnapshotRefSchema
    from radar.restapi.v1.queues.schema import QueueSnapshotRefSchema
