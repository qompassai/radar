...
from radar.restapi.utils import read_text_file

LOGGER: BoundLogger = structlog.stdlib.get_logger()

SCRIPT_FILE_ENCODING: Final[str] = "utf-8"
CURRENT_PACKAGE: Final[str] = "radar.restapi.v1.workflows.lib"
TEMPLATE_FILENAME: Final[str] = "run_radar_job.py.tmpl"


def export_run_radar_job_script(
    job_id: int,
    experiment_id: int,
    ...
    """Render and export the run_radar_job.py script to a specified directory.
    ...
    script_path = Path(base_dir, "run_radar_job").with_suffix(".py")
    script = _render_run_radar_job_script(
        job_id=job_id,
...
def _render_run_radar_job_script(
    job_id: int,
    experiment_id: int,
    task_engine_yaml_path: str,
    job_params_json_path: str,
