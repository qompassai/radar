...
import radar.task_engine.types
...
class RadarTypeError(BaseTaskEngineError):
...
class TypeNotFoundError(RadarTypeError):
    """
...
class NonSimpleSuperTypeError(RadarTypeError):
    """
...
class InvalidKeyTypeError(RadarTypeError):
    """
    ...
    def __init__(
        self,
        invalid_key_type: "radar.task_engine.types.Type",
...
class TooManyTypeStructuresError(RadarTypeError):
    """
    ...
    def __init__(
        self,
        structure_types: Iterable["radar.task_engine.types.StructureType"],
        context_type_name: Optional[str] = None,
    ) -> None:
        message = (
...
class InvalidTypeStructureDefinitionError(RadarTypeError):
    """
...
class BuiltinTypeRedefinitionError(RadarTypeError):
    """
...
class AnonymousSimpleTypeError(RadarTypeError):
    """
