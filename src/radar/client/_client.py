...
class RadarClient(object):
    """Connects to the Radar REST api, and provides access to endpoints.

    Args:
        address: Address of the Radar REST api or if no address is given the
            RADAR_RESTAPI_URI environment variable is used.
        api_version: The version of the Radar REST API to use. Defaults to "v0".

    Notes:
        See https://pages.nist.gov/radar/user-guide/api-reference-restapi.html for
        more information on Radar's REST api.
    """
    ...
    def delete_custom_task_plugin(self, name: str) -> dict[str, Any]:
        ...
        Args:
            name: A unique string identifying a task plugin package within
                radar_custom collection.

        Returns:
            The Radar REST api's response.

            Example::

                {
                    'collection': 'radar_custom',
                    'status': 'Success',
                    'taskPluginName': ['evaluation']
                }

        Notes:
            See https://pages.nist.gov/radar/user-guide/api-reference-restapi.html
            for more information on Radar's REST api.
        """
    ...
    def get_experiment_by_name(self, name: str) -> dict[str, Any]:
        ...
        Returns:
            The Radar REST api's response containing the experiment id, name, and
            metadata.
        ...
        Returns:
            ...
            Example::

                {
                    ...
                    'dependsOn': None,
                    'entryPoint': 'train',
                    'entryPointKwargs': '-P data_dir=/radar/data/Mnist',
                    'experimentId': 10,
                    'jobId': '4eb2305e-57c3-4867-a59f-1a1ecd2033d4',
                    'lastModified': '2023-06-26T15:26:43.100093',
                    'mlflowRunId': None,
